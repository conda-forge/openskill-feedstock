...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openskill-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14066&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openskill-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openskill` can be installed with:

```
conda install openskill
```

It is possible to list all of the versions of `openskill` available on your platform with:
